...
from ddcsum import version
from ddcsum.hashing import hmac_sha_512
...
class Mnemonic(object):
    ...
    def __init__(self, lang=None):
        ...
        s = pkgutil.get_data('ddcsum', os.path.join('wordlist', filename))
    ...
    def mnemonic_to_seed(cls, mnemonic, passphrase):
        ...
        return pbkdf2.PBKDF2(mnemonic, 'ddcsum' + passphrase, iterations=PBKDF2_ROUNDS,
