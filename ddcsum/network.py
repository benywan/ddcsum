...
from ddcsum.constants import COIN, BLOCKS_PER_CHUNK, DEFAULT_PORTS, proxy_modes
from ddcsum.constants import SERVER_RETRY_INTERVAL, NODES_RETRY_INTERVAL
from ddcsum.util import DaemonThread, normalize_version
from ddcsum.blockchain import get_blockchain
from ddcsum.interface import Connection, Interface
from ddcsum.simple_config import SimpleConfig
from ddcsum.version import PROTOCOL_VERSION
    ...
    def maintain_sockets(self):
        ...
        for interface in self.interfaces.values():
            if interface.has_timed_out():
                ...
                params = [DDCSUM_VERSION, PROTOCOL_VERSION]
