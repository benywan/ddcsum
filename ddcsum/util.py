...
import json
import time
from ddcsum.constants import NO_SIGNATURE

log = logging.getLogger("ddcsum")
...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".ddcsum")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "DDCSum")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "DDCSum")
