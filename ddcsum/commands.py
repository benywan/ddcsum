...
from ddcsum.contacts import Contacts
from ddcsum.constants import COIN, TYPE_ADDRESS, TYPE_CLAIM, TYPE_SUPPORT, TYPE_UPDATE
from ddcsum.constants import RECOMMENDED_CLAIMTRIE_HASH_CONFIRMS, MAX_BATCH_QUERY_SIZE
from ddcsum.hashing import Hash, hash_160, hash_encode
from ddcsum.claims import verify_proof
from ddcsum.lbrycrd import decode_claim_id_hex
from ddcsum.lbrycrd import encode_claim_id_hex, encrypt_message, public_key_from_private_key
from ddcsum.lbrycrd import address_from_private_key, verify_message
from ddcsum.transaction import Transaction
from ddcsum.transaction import decode_claim_script, deserialize as deserialize_transaction
from ddcsum.transaction import get_address_from_output_script, script_GetOp
from ddcsum.errors import InvalidProofError, NotEnoughFunds, InvalidClaimId
from ddcsum.util import format_satoshis
from ddcsum.mnemonic import Mnemonic
...
def get_parser():
    ...
    group.add_argument("-D", "--dir", dest="ddcsum_path", help="electrum directory")
